    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        SurrogateIdentityId = c.Long(nullable: false, identity: true),
                        DefinitionIdentityHash = c.Guid(nullable: false),
                        DefinitionIdentityAnyRevisionHash = c.Guid(nullable: false),
                        Name = c.String(),
                        Package = c.String(),
                        Build = c.Long(),
                        Major = c.Long(),
                ...
                .PrimaryKey(t => t.SurrogateIdentityId);
                ...
                c => new
                    {
                        ...
                        ChangeTime = c.Long(nullable: false),
                        EncodingOption = c.Byte(nullable: false),
                        Change = c.Binary(nullable: false),
                    })
                .PrimaryKey(t => new { t.SurrogateInstanceId, t.ChangeTime });
        ...
        public override void Down()
        {
            ...
            DropTable("[System.Activities.DurableInstancing].InstanceMetadataChangesTable");
            ...
            DropTable("[System.Activities.DurableInstancing].DefinitionIdentityTable");
        }
    }
}
